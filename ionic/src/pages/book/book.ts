...
export class BookPage {
  ...
  constructor(public navCtrl: NavController, public dataStore:DataStore, public liveUpdateService:LiveUpdateProvider, renderer: Renderer, private zone: NgZone, public modalCtrl: ModalController, public loadingCtrl: LoadingController) {
    ...
    GETVIEWPATH = {"path":"/workitems/{id}","verbRequestInfo":{"queryAttributes":[],"pathAttributes":[{"name":"id","displayname":"id","parampath":"id","type":"text","required":true,"usage":true,"in":["path","response"],"displayin":["path","response"],"foreignkey":"zWdIhoVF4Gvlfhit","dskey":"iDVXHmD9Ux1E08dc","_id":"6kf0DPHyGmFExoE5"}],"formdataAttributes":[],"bodyAttributes":[],"headerAttributes":[],"dsMoreInfo":{"produces":["application/json"],"consumes":["*/*"],"responseObj":{"200":{"description":"successful operation","schema":{"type":"object","properties":{"description":{"type":"string","name":"description"},"location":{"type":"string","name":"location"},"notes":{"type":"string","name":"notes"},"completed":{"type":"boolean","default":false,"name":"completed"},"id":{"type":"string","name":"id"},"rev":{"type":"string","name":"rev"}}},"headers":{}}},"bodyList":[],"foreignkey":"zWdIhoVF4Gvlfhit","dskey":"iDVXHmD9Ux1E08dc","_id":"QnJP7jjfvbXW688o"}}};
    ...
    PUTEDITPATH = {"path":"/workitems/{id}","verbRequestInfo":{"queryAttributes":[],"pathAttributes":[{"name":"id","displayname":"id","parampath":"id","type":"text","required":true,"usage":true,"in":["path","body"],"displayin":["path","body"],"foreignkey":"8Drr5I0abNSRHg0s","dskey":"iDVXHmD9Ux1E08dc","_id":"smz5aKRm1gXIJeXC"}],"formdataAttributes":[],"bodyAttributes":[{"name":"id","displayname":"id","parampath":"id","type":"text","required":true,"usage":true,"in":["path","body"],"displayin":["path","body"],"foreignkey":"8Drr5I0abNSRHg0s","dskey":"iDVXHmD9Ux1E08dc","_id":"smz5aKRm1gXIJeXC"},{"name":"completed","displayname":"completed","parampath":"completed","type":"boolean","required":false,"default":false,"usage":true,"in":["body"],"displayin":["body"],"foreignkey":"8Drr5I0abNSRHg0s","dskey":"iDVXHmD9Ux1E08dc","_id":"Z8jkxFWCPHPRPvNA"},{"name":"description","displayname":"description","parampath":"description","type":"text","required":false,"usage":true,"in":["body"],"displayin":["body"],"foreignkey":"8Drr5I0abNSRHg0s","dskey":"iDVXHmD9Ux1E08dc","_id":"hJrDpxSKWozP0b3G"},{"name":"location","displayname":"location","parampath":"location","type":"text","required":false,"usage":true,"in":["body"],"displayin":["body"],"foreignkey":"8Drr5I0abNSRHg0s","dskey":"iDVXHmD9Ux1E08dc","_id":"NaXovYvoqAxdSJgt"},{"name":"notes","displayname":"notes","parampath":"notes","type":"text","required":false,"usage":true,"in":["body"],"displayin":["body"],"foreignkey":"8Drr5I0abNSRHg0s","dskey":"iDVXHmD9Ux1E08dc","_id":"haBIyi1loGGp6Ndb"},{"name":"rev","displayname":"rev","parampath":"rev","type":"text","required":false,"usage":true,"in":["body"],"displayin":["body"],"foreignkey":"8Drr5I0abNSRHg0s","dskey":"iDVXHmD9Ux1E08dc","_id":"Vxi4Wlml9uRBKohK"}],"headerAttributes":[],"dsMoreInfo":{"produces":["*/*"],"consumes":["application/json"],"responseObj":{"default":{"description":"successful operation"}},"bodyList":[{"in":"body","name":"body","required":false,"schema":{"type":"object","properties":{"description":{"type":"string","name":"description"},"location":{"type":"string","name":"location"},"notes":{"type":"string","name":"notes"},"completed":{"type":"boolean","default":false,"name":"completed"},"id":{"type":"string","name":"id"},"rev":{"type":"string","name":"rev"}}}}],"foreignkey":"8Drr5I0abNSRHg0s","dskey":"iDVXHmD9Ux1E08dc","_id":"5iItDV5TLClvSXc2"}}};
